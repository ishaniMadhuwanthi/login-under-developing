...
class Otherlogin extends Component{
    ...
    constructor(props) {
        super(props);
        this.goTootherlanding = this.goTootherlanding.bind(this);
      ...
      goTootherlanding = (e) =>{ 
        ...
        this.props.history.replace( '/otherlanding');
    }
    goToHome = (e) =>{ 
      e.preventDefault();
      console.log(this.state);
                ...
                <div className="form-wrapper">
                    ...
                    <form onSubmit={this.handleSubmit} noValidate>
                        ...
                        <div className="createAccount">
                            <button type="submit" onClick={this.goTootherlanding}>Sign In</button> 
                        </div>
                    </form>
                </div>
            </div>
